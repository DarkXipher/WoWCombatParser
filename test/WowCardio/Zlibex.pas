...
type
  ...
  private     //ajout cartographe
    foffsetstart:integer; //ajout cartographe
  public
...
begin
  ...
  foffsetstart:=FStreampos; //ajout cartographe
...
begin
  ...
  begin
    ...
    FStream.Position := foffsetstart;//ajout cartographe
    FStreamPos := foffsetstart;//ajout cartographe
  end
